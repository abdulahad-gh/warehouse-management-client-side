...
const Contact = () => {
    return (
        <div className='px-4 md:px-20 mt-20 md:mt-24 '>
            <h2 className='text-center text-3xl mb-10 md:mb-16'>Contact</h2>

            <div className='grid md:grid-cols-2 gap-2'>
                <div>
                    <img width={400} src="https://i.ibb.co/zZqT2Xm/download-removebg-preview.png" alt="" />
                </div>
                ...
                <form className='bg-white '>
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6  bg-white">
