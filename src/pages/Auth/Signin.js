    ...
    return (
        ...
        <div className='h-screen  items-center flex px-4'>
            <form className='w-80 mx-auto' onSubmit={handleLogInUser}>
                ...
                <div>
                    <span>already account? please <Link className='text-blue-700	ml-1	' to='signup'>SignUp</Link></span>
                </div>
                <p >forget password<button onClick={() => {
                    if (userLogInInfo.email === "") {
                        ...
                        alert('send passowrd reset email,check your email')
                        sendPasswordResetEmail(userLogInInfo.email)
                    }

                }} className='text-blue-700	ml-1 '>-Reset</button></p>
